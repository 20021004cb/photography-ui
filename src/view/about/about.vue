<template>
    ...
    <div class="infoDiv">
        <p>
            <font>
                <strong style=" font-size: 30px;">RELIABLE PHOTOGRAPHY STUDIO</strong>
            </font>
        </p>
        <span
            style="font-family: &quot;Times New Roman&quot; letter-spacing: 0.4pt; color: rgb(255, 255, 255); font-size: 19px;">commercial
            photography</span>
        <h1 style="margin-top: 10px;">上海零点好奇影视有限公司</h1>
    </div>
    <div class="topDiv">
    ...
    <div class="aboutContentDiv">
        ...
        <div class="memberDiv" style="height: 1100px;  margin-top: 55px;">
            <div class="memberDetailDiv" style=" width: 13%; height: 9%;  position: absolute;left: 15%; ">
            ...
            <div class="memberDetailDiv" style=" width: 13%; height: 9%; position: absolute;left: 35%; ">
            ...
            <div class="memberDetailDiv" style=" width: 13%; height: 9%;  position: absolute;left: 52%; ">
            ...
            <div class="memberDetailDiv" style=" width: 13%; height: 9%;  position: absolute;left: 70%; ">
