  ...
  setup() {
    ...
    const photoShowList = reactive({
      photoArray: <any>[]
        ...
        addPhotoList({videoUrl: require("@/assets/videoContents/video1.mp4"), imgUrl: require("@/assets/videoContents/video1.jpg"), msg: "SONY ZV-E1 LAUNCH FILM", id: "video1", visible: false })
        addPhotoList({videoUrl: require("@/assets/videoContents/video2.mp4"), imgUrl: require("@/assets/videoContents/video2.jpg"), msg: "SONY ZV-E1 LAUNCH FILM", id: "video2", visible: false })
        addPhotoList({videoUrl: require("@/assets/videoContents/video3.mp4"), imgUrl: require("@/assets/videoContents/video3.jpg"), msg: "SONY ZV-E1 LAUNCH FILM", id: "video3", visible: false })
        addPhotoList({videoUrl: require("@/assets/videoContents/video4.mp4"), imgUrl: require("@/assets/videoContents/video4.jpg"), msg: "SONY ZV-E1 LAUNCH FILM", id: "video4", visible: false })
        addPhotoList({videoUrl: require("@/assets/videoContents/video5.mp4"), imgUrl: require("@/assets/videoContents/video5.jpg"), msg: "SONY ZV-E1 LAUNCH FILM", id: "video5", visible: false })
